  ...
  /*  '<div style = {{visibility:  'hidden'}}><h1>PDF</h1>
        ...
        switch (this.state.value){
          case 0:
            ...
            break;
          case 1: 
            children =( <BasicTextFields age  = {this.state.age != null?this.state.age:{"Sexo": 'Default', "Estado Civil":'Default'}} Alergias ={this.state.Alergias!= null?this.state.Alergias: {}} checkBox = {this.state.checkBox!=null?this.state.checkBox: {'Tetraciclina': false,'Amoxiciclina': false, 'Acitromicina': false, 'Ciprofloxacino': false,  'Doxiciclina': false, 'Codeína': false, 'Claritomicina': false, 'Sulfonamida': false, 'Penicilina': false}} datos ={this.state.datos != null ? this.state.datos: {}} Otros = {this.state.Otros!=null ? this.state.Otros: {}} patient={this.state.patient} id = 'Nota_de_Evolucion'
            steps = {['Datos Personales', 'Alergias', 'Otras Alergias', 'hkdsjhkdjhks', 'ksjdhksjhkdj', 'jaksjkasjahks','jashkajhskajshka', '19812098210982']
          }
            props = {{owner: this.state.owner,titles : ['Nota de Evolución'], inputs :[
              {type: 'input',label: 'Nombre',sec: 'datos', index: 0},
              {type: 'input',label: 'Apellido',sec: 'datos', index: 0},
                {type: 'input',label: 'Edad*',sec: 'datos', index: 0},
                 {type: 'MS', sec: 'datos',ops : ['Masculino', 'Femenino', 'Otro'],label: 'Sexo', index: 0},
                 ...
                 {type: 'title', label: 'Alergias*', index : 1},
                 {type: 'B',id: 'med_*',sec: 'alergias med', label: 'El paciente presenta alergias',cons: 'No', index: 1},
                 {type: 'CheckList',sec: 'alergias prod', label: 'Alergias a Medicamentos ', lista: ['Tetraciclina_*','Amoxiciclina_*', 'Acitromicina_*', 'Ciprofloxacino_*',  'Doxiciclina_*', 'Codeína_*', 'Claritomicina_*', 'Sulfonamida_*', 'Penicilina_*'] ,index: 1},
                 {type: 'CheckList', sec: 'alergias prod',label: '', lista: ['Ibuporfeno_*','Lidocaína_*', 'Naproxeno_*', 'Oxicodona_*',  'Aspirina_*', 'Entromicina_*', 'Yodo_*', 'Morfina_*', 'Otros'] ,index: 1},
                 {type: 'B', id : 'otras_*', sec: 'alergias prod',label: 'El paciente presenta alergia a algún otro producto',cons: 'No', index: 2},
                 {type: 'CheckList',sec: 'alergias prod', label: 'Alergias a productos diarios', lista: ['Huevos_*','Leche_*', 'Productos Lacteos_*'] ,index: 2},
                 {type: 'CheckList',sec: 'alergias prod', label: '', lista: ['Comida de Mar_*', 'Almendras_*', 'Otros'] ,index: 2},
                 {type: 'title',  label: 'Historia Clínica', index : 3},
                 {type: 'B', sec: 'Diagnosticos',id: 'med2_*', label: 'El paciente ha sido diagnosticado con alguno de los siguientes padecimientos: ',cons: 'No', index: 3},
                 {type: 'CheckList',  sec: 'Diagnosticos',label: '', lista: ['Reflujo Acido_*','Coágulos de sangre_*', 'Enfermedad de la Arteria Coronaria_*', 'Epilepsia_*',  'Ataque al corazon*', 'Ulcera Estomacal', 'Enfermedad de la tiroides'] ,index: 3},
                 {type: 'CheckList', sec: 'Diagnosticos', label: '', lista: ['Asma_*','Cancer_*', 'Diabetes_*', 'Ataque al corazon_*',  'Enfermedades de riñon_*', 'Infarto_*', 'Otros'] ,index: 3},
                 {type: 'B',id: 'med3_*', sec: 'Cirujias', label: 'El paciente ha tenido procedimientos quirurjicos: ',cons: 'No', index: 4},
                 {type: 'CheckList', sec: 'Cirujias',label: '', lista: ['Angioplastía_*','Cirujía de Espalda_*', 'Bypass de corazón_*', 'Remplazo de cadera_*',  'Marcapaso_*', 'Vasectomía_*'] ,index: 4},
                 {type: 'CheckList', sec: 'Cirujias',label: '', lista: ['Apendectomía_*','Cirujía vesícula biliar_*', 'Reparación de Hernia_*', 'Cirujía de Rodilla_*',  'Amigdalectnomía_*', 'Otros'] ,index: 4},
                 {type: 'B',id: 'med4_*',sec: 'Genética', label: 'Historial familiar: ',cons: 'No aplica', index: 5},
                 {type: 'CheckList', sec: 'Genética',label: '', lista: ['Alzheimer_*','Cáncer_*', 'Diabetes_*', 'Colesterol alto_*',  'Enfermedad del Riñón_*', 'Osteoporosis_*', 'Infartos_*'] ,index: 5},
                 {type: 'CheckList', sec: 'Genética', label: '', lista: ['Asma_*','Enfermedad de la Arteria Coronada_*', 'Ataque al corazón_*', 'Hipertensión_*',  'Migrañas_*', 'Otros'] ,index: 5},
                 {type: 'B',id: 'med5_*', styles :{hola:'hola'}, label: 'Uso de sustancias: ',cons: 'No aplica', index: 6},
                
                 {type: 'CheckList', label: 'Uso de sustancias', lista: ['Tabaco_*','Alcohol_*', 'Otros'] ,index: 6},
                 {type: 'B',id: 'med6_*', sec: 'Uso de sustancias', label: 'Uso de sustancias ilicitas: ',cons: 'No aplica', index: 6},
                 {type: 'input',  sec: 'Uso de sustancias',label: 'Uso de sustancias Ilicitas_*', index: 6},
                 {type: 'input',  sec: 'datos medicos',label: 'Temperatura_*', index: 7},
                 {type: 'input', sec: 'datos medicos',label: 'Tensión Arterial_*', index: 7},
                 {type: 'input', sec: 'datos medicos',label: 'Frecuencia Cardiaca_*', index: 7},
                 {type: 'input', sec: 'datos medicos',label: 'Frecuencia Respiratoria_*', index: 7},
               
    
                 {type: 'multiline_input',sec: 'datos vitales', label: 'Datos Especificos_*', index: 7}, 
                 {type: 'multiline_input', sec: 'datos medicos',label: 'Resultados previos de Laboratorio_*', index: 7}, 
                 {type: 'multiline_input', sec: 'datos medicos',label: 'Resultados actuales de Laboratorio_*', index: 7}, 
                 {type: 'multiline_input', sec: 'datos medicos',label: 'Diagnosticos o Problemas Clínicos_*', index: 7},  
                 {type: 'multiline_input', sec: 'datos medicos',label: 'Pronóstico_*', index: 7},    
                 {type: 'multiline_input', sec: 'datos medicos',label: 'Indicación Terapeutica_*', index: 7},         
          ...
          break;
          case 2:
            children = (<BasicTextFields age  = {this.state.age != null?this.state.age:{"Sexo": 'Default', "Estado Civil":'Default'}} Alergias ={this.state.Alergias!= null?this.state.Alergias: {}} checkBox = {this.state.checkBox!=null?this.state.checkBox: {'Tetraciclina': false,'Amoxiciclina': false, 'Acitromicina': false, 'Ciprofloxacino': false,  'Doxiciclina': false, 'Codeína': false, 'Claritomicina': false, 'Sulfonamida': false, 'Penicilina': false}} datos ={this.state.datos != null ? this.state.datos: {}} Otros = {this.state.Otros!=null ? this.state.Otros: {}} patient={this.state.patient} id = 'Nota_de_Interconsulta'
            steps = {['Nota de Interconsulta']
          }
            props = {{owner: this.state.owner,titles : ['Nota de Evolución'], inputs :[
              {type: 'input',label: 'Criterios Diagnósticos',sec: 'datos', index: 0},
              {type: 'multiline_input',label: 'Plan de Estudios',sec: 'dato medicos', index: 0},
              {type: 'multiline_input',label: 'Sugerencias Diagnósticas y de Tratamiento',sec: 'datos medicos', index: 0},
            ...
            break;
            case 3:
            children = (<BasicTextFields age  = {this.state.age != null?this.state.age:{"Sexo": 'Default', "Estado Civil":'Default'}} Alergias ={this.state.Alergias!= null?this.state.Alergias: {}} checkBox = {this.state.checkBox!=null?this.state.checkBox: {'Tetraciclina': false,'Amoxiciclina': false, 'Acitromicina': false, 'Ciprofloxacino': false,  'Doxiciclina': false, 'Codeína': false, 'Claritomicina': false, 'Sulfonamida': false, 'Penicilina': false}} datos ={this.state.datos != null ? this.state.datos: {}} Otros = {this.state.Otros!=null ? this.state.Otros: {}} patient={this.state.patient} id = 'Nota_de_Referencia'
            steps = {['Datos de Referencia/Traslado', 'Resumen Clínico', 'Otras Alergias', 'hkdsjhkdjhks', 'ksjdhksjhkdj', 'jaksjkasjahks','jashkajhskajshka', '19812098210982']
          }
            props = {{owner: this.state.owner,titles : ['Nota de Referencia/Traslado'], inputs :[
              {type: 'input',label: 'Establecimiento que envía',sec: 'datos', index: 0},
              {type: 'input',label: 'Establecimiento receptor',sec: 'datos', index: 0},
              {type: 'title', label: 'Resumen Clínico', index : 1},
              {type: 'input',label: 'Establecimiento receptor',sec: 'datos', index: 0},
              {type: 'input',label: 'Motivo de Envío',sec: 'datos', index: 0},
              {type:  'multiline_input',label: 'Impresión Diagnóstica',sec: 'datos', index: 0},
              {type:  'multiline_input',label: 'Terapéutica Empleada',sec: 'datos', index: 0},
              {type: 'title', label: 'Alergias', index : 1},
                 {type: 'B',id: 'med2*',sec: 'alergias med', label: 'El paciente presenta alergias',cons: 'No', index: 1},
                 {type: 'CheckList',sec: 'alergias prod', label: 'Alergias a Medicamentos *', lista: ['Tetraciclina *','Amoxiciclina *', 'Acitromicina *', 'Ciprofloxacino *',  'Doxiciclina *', 'Codeína *', 'Claritomicina *', 'Sulfonamida *', 'Penicilina'] ,index: 1},
                 {type: 'CheckList', sec: 'alergias prod',label: '', lista: ['Ibuporfeno *','Lidocaína *', 'Naproxeno *', 'Oxicodona *',  'Aspirina *', 'Entromicina *', 'Yodo *', 'Morfina *', 'Otros'] ,index: 1},
                 {type: 'B', id : 'otras*', sec: 'alergias prod',label: 'El paciente presenta alergia a algún otro producto',cons: 'No', index: 2},
                 {type: 'CheckList',sec: 'alergias prod', label: 'Alergias a productos diarios *', lista: ['Huevos *','Leche *', 'Productos Lacteos *'] ,index: 2},
                 ...
                 {type: 'CheckList',  sec: 'Diagnosticos',label: '', lista: ['Reflujo Acido*','Coágulos de sangre*', 'Enfermedad de la Arteria Coronaria*', 'Epilepsia*',  'Ataque al corazon*', 'Ulcera Estomacal*', 'Enfermedad de la tiroides*'] ,index: 3},
                 {type: 'CheckList', sec: 'Diagnosticos', label: '', lista: ['Asma *','Cancer *', 'Diabetes *', 'Ataque al corazon *',  'Enfermedades de riñon *', 'Infarto *', 'Otros'] ,index: 3},
                 {type: 'B',id: 'med3 *', sec: 'Cirujias', label: 'El paciente ha tenido procedimientos quirurjicos: ',cons: 'No', index: 4},
                 {type: 'CheckList', sec: 'Cirujias',label: '', lista: ['Angioplastía *','Cirujía de Espalda *', 'Bypass de corazón *', 'Remplazo de cadera *',  'Marcapaso *', 'Vasectomía *'] ,index: 4},
                 {type: 'CheckList', sec: 'Cirujias',label: '', lista: ['Apendectomía *','Cirujía vesícula biliar *', 'Reparación de Hernia *', 'Cirujía de Rodilla *',  'Amigdalectnomía *', 'Otros'] ,index: 4},
                 {type: 'B',id: 'med4 *',sec: 'Genética', label: 'Historial familiar: ',cons: 'No aplica', index: 5},
                 {type: 'CheckList', sec: 'Genética',label: '', lista: ['Alzheimer *','Cáncer *', 'Diabetes *', 'Colesterol alto *',  'Enfermedad del Riñón *', 'Osteoporosis *', 'Infartos *'] ,index: 5},
                 {type: 'CheckList', sec: 'Genética', label: '', lista: ['Asma *','Enfermedad de la Arteria Coronada *', 'Ataque al corazón *', 'Hipertensión *',  'Migrañas *', 'Otros'] ,index: 5},
                 {type: 'B',id: 'med5 *', styles :{hola:'hola'}, label: 'Uso de sustancias: ',cons: 'No aplica', index: 6},
                
                 {type: 'CheckList', label: 'Uso de sustancias', lista: ['Tabaco','Alcohol', 'Otros'] ,index: 6},
                 {type: 'B',id: 'med6 *', sec: 'Uso de sustancias', label: 'Uso de sustancias ilicitas: ',cons: 'No aplica', index: 6},
                 {type: 'input',  sec: 'Uso de sustancias',label: 'Uso de sustancias Ilicitas *', index: 6},
                 {type: 'input',  sec: 'datos medicos',label: 'Temperatura *', index: 7},
                 {type: 'input', sec: 'datos medicos',label: 'Tensión Arterial *', index: 7},
                 {type: 'input', sec: 'datos medicos',label: 'Frecuencia Cardiaca *', index: 7},
                 ...
                 {type: 'multiline_input', sec: 'datos medicos',label: 'Diagnosticos o Problemas Clínicos *', index: 7},  
                 {type: 'multiline_input', sec: 'datos medicos',label: 'Pronóstico *', index: 7},    
                 {type: 'multiline_input', sec: 'datos medicos',label: 'Tratamiento*', index: 7},         
