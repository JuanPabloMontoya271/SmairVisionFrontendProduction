...
export default function MyAppBar() {
  ...
  return (
    <div className={classes.grow}>
      ...
      {renderMobileMenu}
      {renderMenu}
      <div style = {{width:  '4vw', height: '94vh',zIndex:-1, position: 'absolute', left:0, top:'6vh'}} onMouseOver= {toggleDrawer('left', true)}></div>
     
      <div style = {{backgroundColor : 'red', position: "absolute", top: '100px'}}>
